...
Get data from year 2013-2016 and 2018-2022
...
```{r}
wpt_functional2013 <- wpt_functional %>% 
  filter(Year %in% c("2013", "2014", "2015", "2016" ))

wpt_functional2018 <- wpt_functional %>% 
  filter(Year %in% c("2018", "2019", "2020", "2021", "2022"))
```
...
```{r}
wpt_nonfunctional2013 <- wpt_nonfunctional %>% 
  filter(Year %in% c("2013", "2014", "2015", "2016" ))

wpt_nonfunctional2018 <- wpt_nonfunctional %>% 
  filter(Year %in% c("2018", "2019", "2020", "2021", "2022"))
```
...
```{r}
wpt_unknown2013 <- wpt_unknown %>% 
  filter(Year %in% c("2013", "2014", "2015", "2016" ))

wpt_unknown2018 <- wpt_unknown %>% 
  filter(Year %in% c("2018", "2019", "2020", "2021", "2022"))
```
